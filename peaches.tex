...
\begin{figure*}[htbp!]
  ...
  \caption{The derived gas column and volumn densities for the PEACHES protostars sorted by their gas column density.}
  \label{fig:Ngas_ngas}
\end{figure*}
