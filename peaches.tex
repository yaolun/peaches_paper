...
While the column density shows 


{\color{pink}To confirm this correlation, we have also prepared normalized correlation plots.  [explain the method, and meaning of the normalization] Similar values of the correlation coefficient are obtained.
...
{\color{pink}Among hot corino sources, no tight correlations are seen as well (FigureXX). [explain the plots]  On the other hand, when we take relative abundance to CH3OH, marginal trend could be seen in correlation between Tcont.  [explain what you presented in the talk.  more complex species may require higher density?  ]}  

\subsection{O-bearing and N-bearing COMs}
{\color{pink}- perfect correlation between CH3OH and CH3CN -> both could be 1st generation species.  No significant difference between o-bearing and N-bearing abundances among the YSOs in perseus. (at least, elemental abundance could be almost the same since our samples are in the same cloud complex.)
...
{\color{pink}- CH3OH formation is well known(surface hydrogenation)
